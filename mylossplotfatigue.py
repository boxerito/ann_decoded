...
axs[0].set_title('Mean Training Loss (fatigue level, Training Examples)')
...
axs[1].set_title('Mean Validation Loss (fatigue level, Training Examples)')

# # Save the figure
plt.tight_layout()
fig.colorbar(im2, ax=axs, label='Mean Validation Loss', location='right')
plt.savefig(f'ANNpictures/mean_loss_fatigue.png')
